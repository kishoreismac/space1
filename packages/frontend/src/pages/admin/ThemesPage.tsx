      ...
      <aside className="lg:col-span-1 bg-white rounded-lg border border-slate-200 p-4">
        ...
        <ul className="divide-y divide-slate-100">
          ...
          {!themes.isLoading && (themes.data?.items.length ?? 0) === 0 && (
            <li className="text-sm text-slate-500 py-2">No themes yet. Click Auto Analyse to generate questionnaire, numeric, text, and cross-dimension metric blockers automatically.</li>
          )}
        </ul>
      </aside>
