...
export const PHASE_CONFIG: Record<PhaseId, PhaseConfig> = {
  ...
  P2: {
    id: 'P2', number: '02', tag: 'PHASE 2 · THEME ANALYSIS',
    title: 'Evidence Theme Clustering & JTBD Extraction',
    timing: 'Week 1-2 · 3-4 days · 2 analysts + facilitator',
    accent: '#B06A10',
    activities: [
      { title: 'Generate Evidence Themes',
        body: 'Create themes from questionnaire blocker signals, low numeric answers, cross-dimension patterns, and semantic clusters from free-text responses. Capture representative quotes where text evidence exists.' },
      ...
      { title: 'Anti-Confirmation: Misalignment Check',
        body: 'Compare each theme against the quantitative score for its parent dimension or cross-pattern. If a high-frequency signal contradicts the score, flag it as Investigate — do not promote until P3 cross-validation confirms.',
        tools: ['Questionnaire signals', '30 % rule', 'JTBD', 'Cross-pattern evidence'] },
    ],
