...
export const CampaignCreateSchema = z.object({
  ...
  assessmentLead: z.string().max(200).optional().nullable(),
  vpEmail: z.string().email().max(200).optional().nullable(),
  previousCycleLabel: z.string().max(50).optional().nullable(),
  previousS: z.number().min(0).max(5).optional().nullable(),
  previousP: z.number().min(0).max(5).optional().nullable(),
  previousA: z.number().min(0).max(5).optional().nullable(),
  previousC: z.number().min(0).max(5).optional().nullable(),
  previousE: z.number().min(0).max(5).optional().nullable(),
  execSummarySubject: z.string().max(500).optional().nullable(),
  execSummaryFindings: z.string().max(8000).optional().nullable(),
  execSummaryNextSteps: z.string().max(8000).optional().nullable(),
  execSummaryImmediate: z.string().max(8000).optional().nullable(),
});
...
export const CampaignSchema = z.object({
  ...
  assessmentLead: z.string().nullable().optional(),
  vpEmail: z.string().nullable().optional(),
  previousCycleLabel: z.string().nullable().optional(),
  previousS: z.number().nullable().optional(),
  previousP: z.number().nullable().optional(),
  previousA: z.number().nullable().optional(),
  previousC: z.number().nullable().optional(),
  previousE: z.number().nullable().optional(),
  execSummarySubject: z.string().nullable().optional(),
  execSummaryFindings: z.string().nullable().optional(),
  execSummaryNextSteps: z.string().nullable().optional(),
  execSummaryImmediate: z.string().nullable().optional(),
  createdAt: z.string(),
  updatedAt: z.string(),
});
